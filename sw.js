const CACHE='agrivision-production-v1';
const CORE=[
  ...
  './assets/maps/map-zone1.png','./assets/maps/map-zone2.png','./assets/maps/map-zone3.png','./assets/maps/map-all.png','./manifest.webmanifest'
];
